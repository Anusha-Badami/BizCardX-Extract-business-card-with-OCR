...
if select == "Home":
  st.markdown("### :orange[**Technologies Used :**] Python,Easy OCR, Streamlit, SQL, Numpy , Pandas")



  st.write(
            "### :red[**About :**] Bizcard: A Python application designed to extract information from business cards")
  st.write(
            '###  Bizcard primary function is to streamline the extraction of essential information from business card images. Utilizing the advanced OCR (Optical Character Recognition) capabilities of EasyOCR, Bizcard efficiently captures details like names, job titles, company names, contact details, other pertinent data from the images.')
